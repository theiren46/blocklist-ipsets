...
The following list was automatically generated on Wed Aug  5 16:54:09 UTC 2015.
...
bds_atif|[Binary Defense Systems Artillery Threat Intelligence Feed and Banlist Feed](https://www.binarydefense.com/banlist.txt)|ipv4 hash:ip|disabled|updated every 1 hour  from [this link](https://www.binarydefense.com/banlist.txt)
...
[firehol_level2](http://ktsaou.github.io/blocklist-ipsets/?ipset=firehol_level2)|An ipset made from blocklists that track attacks, during the last one or two days. (includes: openbl_1d dshield_1d blocklist_de stopforumspam_1d botscout_1d greensnow)|ipv4 hash:net|27991 subnets, 102274 unique IPs|
...
proxyspy|[ProxySpy](http://spys.ru/en/) open proxies (updated hourly)|ipv4 hash:ip|disabled|updated every 1 hour  from [this link](http://txt.proxyspy.net/proxy.txt)
